	 ...
	 \begin{columns}
		...
		\begin{column}{0.7\textwidth}
			\begin{itemize}
				...
				\item Calcul du TEC et du délai ionosphérique avec \textit{Python} {\tiny (Voir Annexe 7)}.
			\end{itemize}
		\end{column}
	 \end{columns}
\end{frame}
...
\begin{frame}{Résultats}
	L'estimation du TEC est possible que sur de courte session due aux \textit{duty cycle} {\tiny (Voir Annexe 3)}
	\begin{figure}
		\centering
...
\begin{frame}{Résultats}
	Mp en intérieur, extérieur en ville et en campagne; statique.
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{./Figures/mp_exp.png}
