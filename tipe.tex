...
\begin{frame}
	\frametitle{Introduction}
		...
		\begin{figure}
			...
			\caption {Appareils GNSS par plate-forme. \textit{Market report, ESA}}
		\end{figure}
\end{frame}
\begin{frame}
...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.7\textwidth]{./Figures/GPS_XENS.png} \\
		\caption {Fonctionnement du GPS. \textit{Source: Sujet X-ENS 2016}}
	\end{figure}
\end{frame}
\begin{frame}
