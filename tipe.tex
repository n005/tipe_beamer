	 ...
	 \begin{columns}
		\begin{column}{0.3\textwidth}
			\begin{figure}
				...
				\caption {Outil de calcul du TEC, tecq \textit{UNAVCO}}	
			\end{figure}
			\begin{figure}
				\centering
				\includegraphics[width=0.7\textwidth]{./Figures/rtklib.jpg}
		...
		\begin{column}{0.7\textwidth}
			\begin{itemize}
				...
				\item Calcul du TEC à partir de la phase et de la speudorange.
			\end{itemize}
		\end{column}
	 \end{columns}
\end{frame}
